...
This codebase includes a [AGENTS.md](./AGENTS.md) file that provides guidance to AI assistants (OpenCode) when working with code in this repository. It contains:
...
Originally built by [Bridger Tower](https://twitter.com/bridgertower) and [Cameron Youngblood](https://twitter.com/youngbloodcyb) at [9d8](https://9d8.dev)
